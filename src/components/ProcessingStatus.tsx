...
import { Loader2, CheckCircle, AlertCircle, Upload, Cog, Wand2, Download, Mic } from 'lucide-react'
...
const ProcessingStatusComponent: React.FC<ProcessingStatusProps> = ({ status }) => {
  const getIcon = () => {
    switch (status.stage) {
      case 'loading_engine':
